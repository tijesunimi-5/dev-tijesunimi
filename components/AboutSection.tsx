...
const AboutSection = () => {
  ...
  useEffect(() => {
    // Fade in animation for the content card when activeTab changes
      ...
      <div ref={tabDisplayRef}>
        <div className="about-card mt-10 overflow-x-scroll w-[320px] md:w-[500px] md:overflow-x-hidden lg:w-[400px] lg:mt-0 xl:w-[600px]">
          <div className="tabs flex justify-between items-center w-[400px] md:w-full">
            <div onClick={() => setActiveTab(1)} className={`${activeTab === 1 ? "bg-[#FAA037] text-[#ffffff]" : "bg-[#a4795e] text-[#FAA037]"} py-1 px-3 rounded-xl cursor-pointer`}>
              Info
            </div>

            <div onClick={() => setActiveTab(2)} className={`${activeTab === 2 ? "bg-[#FAA037] text-[#ffffff]" : "bg-[#a4795e] text-[#FAA037]"} py-1 px-3 rounded-xl cursor-pointer`}>
              Education
            </div>

            <div onClick={() => setActiveTab(3)} className={`${activeTab === 3 ? "bg-[#FAA037] text-[#ffffff]" : "bg-[#a4795e] text-[#FAA037]"} py-1 px-3 rounded-xl cursor-pointer`}>
              Tech Stack
            </div>

            <div onClick={() => setActiveTab(4)} className={`${activeTab === 4 ? "bg-[#FAA037] text-[#ffffff]" : "bg-[#a4795e] text-[#FAA037]"} py-1 px-3 rounded-xl cursor-pointer`}>
              Experience
            </div>
          </div>
        </div>
