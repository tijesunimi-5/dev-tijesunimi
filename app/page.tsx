...
export default function Home() {
  return (
    <section className="py-10 relative w-screen overflow-x-hidden">
      <TabSection />
      <div id="hero" className="hero-section h-[100vh] px-5 pt-28 md:px-10 md:h-[90vh] lg:flex lg:justify-between lg:items-center xl:px-32">
        <div className="col1">
          ...
          <div className="content">
            ...
            <div className="skills flex items-center mt-7 gap-3">
              ...
              <div className="bg-[#a4795e] py-1 px-3 rounded-2xl hidden md:block">
                UI Development
              </div>
              <div className="bg-[#a4795e] py-1 px-3 rounded-2xl hidden md:block">
                Accessibilty
              </div>
              <div className="bg-[#a4795e] py-1 px-2 rounded-2xl md:hidden">
                +8
              </div>
            </div>
        ...
        <div className="hidden lg:block relative lg:mr-20">
          <div className="lin absolute top-[-120px] right-[80px] flex items-center">
            ...
            <Link href={'/'}><img src='/linkedin.png' className="absolute text-2xl right-[18px] top-3" /></Link>
          </div>
