...
export default function Home() {
  useEffect(() => {
    ...
    // Hero section animations - play on enter, fade out on leave
    gsap.fromTo(
      '#hero',
      { opacity: 1, y: 0 },
      {
  ...
  return (
    <div>
      ...
      <div className="sections-container">
        <section id="hero" className="section h-screen px-5 pt-28 md:px-10 lg:flex lg:justify-between lg:items-center xl:px-32">
          <div className="col1">
